    ...
    <div style={{ background: 'var(--bg-primary)', minHeight: '100vh', direction: 'rtl' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        {[
          ...
          { title: '٤. الشحن والتوصيل', body: 'يتم الشحن خلال 3-7 أيام عمل داخل المملكة العربية السعودية عبر شركات Aramex أو SMSA أو DHL. تتحمل SAUDILUX تكلفة الشحن على الطلبات فوق 299 SAR.' },
