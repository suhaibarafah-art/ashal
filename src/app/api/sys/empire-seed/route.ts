...
export async function GET() {
  try {
    ...
    const coupons = [
      ...
      { code: 'LUXURY10',     discountPct: 0.10, maxUsage: 5000  }, // TikTok campaign
      { code: 'SOVEREIGN10',  discountPct: 0.10, maxUsage: 5000  }, // Abandoned cart recovery
    ];
    ...
    return NextResponse.json({
      ...
      couponsSeeded: ['SAVE10', 'ROYAL20', 'VIP15', 'LUXURY10', 'SOVEREIGN10'],
