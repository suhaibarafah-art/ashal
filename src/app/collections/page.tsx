    ...
    <main style={{ background: 'var(--bg-primary)', minHeight: '100vh' }}>
      <div style={{ background: '#002366', borderBottom: '3px solid #FF8C00', padding: '48px 0 40px' }}>
        <div className="container">
          <p style={{ fontFamily: 'var(--font-montserrat)', fontSize: '11px', color: 'rgba(144,202,249,0.7)', textTransform: 'uppercase', letterSpacing: '3px', marginBottom: '8px' }}>ALL COLLECTIONS</p>
      ...
      {products.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '80px 0' }}>
          ...
          <p style={{ fontFamily: 'var(--font-cairo)', fontSize: '18px', color: 'var(--text-muted)', marginBottom: '24px' }}>لا توجد منتجات بعد</p>
        </div>
      ) : (
