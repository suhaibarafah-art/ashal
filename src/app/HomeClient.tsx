...
export default function HomeClient({ products }: HomeClientProps) {
  ...
  return (
    <main style={{ background: 'var(--bg-primary)' }}>
      ...
      {/* ═══ HERO ═══ */}
      <section ref={heroRef} className="relative w-full overflow-hidden" style={{ minHeight: '85vh', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '-108px', paddingTop: '108px' }}>
